...
class LimitedSyncStrategy implements SyncStrategyInterface
{
    ...
    public function sync(): SyncResultDTO
    {
        ...
        try {
            $products = $this->client->getProducts($this->limit);
            ...
            IntegrationLogger::error('Limited sync error', ['error' => $e->getMessage(), 'limit' => $this->limit]);
        }
